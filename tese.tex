...
% Apendices
\appendix
\chapter{Practical Example of Graph Exploration} %opcional
...
% TODO FIX THIS 
\FRDitadata{04 de Novembro de 2024}
\FRDitadocnro{DCTA/ITA/TC-062/2024} %(o número de registro você solicita a biblioteca)
\FRDitaorgaointerno{Instituto Tecnológico de Aeronáutica -- ITA}
%Exemplo no caso de pós-graduação: Instituto Tecnol{\'o}gico de Aeron{\'a}utica -- ITA
\FRDitapalavrasautor{Graph, Search, Multi-Agent, Mixed-Radix}
\FRDitapalavrasresult{Algoritmos; Sistemas multiagentes; Árvores (Matemática); Gráficos (Computação); Trajetória; Computação.}
