...
This work aims to address this gap by presenting a continuation and expansion of a method initially developed for perfect maze exploration \cite{Naeem2021}, as discussed by \citen{Arthur2023}. Building upon this groundwork, the research extends the method to accommodate diverse graph structures by removing dependencies on specific projects. Additionally, it seeks to compare and establish a lower bound on the time complexity for graphs with varying properties.
